...
public class MaintenanceController {
    ...
    @GetMapping("/sorted")
    public ResponseEntity<List<MaintenanceResponse>> getMaintenancesSorted(@RequestParam(defaultValue = "title") String sortBy, @RequestParam(defaultValue = "asc") String sortDir){
