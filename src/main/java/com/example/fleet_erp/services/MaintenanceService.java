...
public class MaintenanceService {
    ...
    public Page<MaintenanceResponse> getMaintenances(int page, int size, String sortBy,String sortDir)
    {
    ...
    public MaintenanceResponse addMaintenance(MaintenanceRequest req){
       ...
       newMaintenance.setCreatedAt(req.getCreatedAt());
       newMaintenance.setUpdatedAt(req.getUpdatedAt());
    ...
    public MaintenanceResponse updateMaintenance(MaintenanceRequest req, UUID id){
        ...
        .findById(id).orElseThrow(()-> new IllegalArgumentException("Maintenance with id " + req.getTitle()+ " does not exists"));
